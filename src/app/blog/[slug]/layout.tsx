...
const samplePostsDataForSlugPage: BlogPost[] = [
  {
    ...
    description:
      "A beginner-friendly guide to setting up your first Next.js 14 application.",
  ...
  },
  {
    ...
    description:
      "Explore breathtaking views and cultures with our top picks for your next vacation.",
    content:
      "From the serene beaches of Bali to the historic streets of Rome... <br /><br />1. Bali, Indonesia <br />2. Rome, Italy <br />3. Kyoto, Japan <br />4. Paris, France <br />5. Banff National Park, Canada",
    date: "2024-03-12",
    category: "Travel",
  ...
  },
  {
    ...
    description:
      "Learn how to make pizzeria-quality pizza in the comfort of your own kitchen.",
    content:
      "Crafting the perfect pizza at home is an art... <br /><br />Key ingredients: <br />- Dough <br />- Tomato Sauce <br />- Cheese <br />- Your favorite toppings",
    date: "2024-03-15",
    category: "Food",
    author: "Chef G",
  },
  {
    ...
    description:
      "A comprehensive overview of cloud computing models, services, and benefits.",
    content:
      "Cloud computing has revolutionized the way businesses operate... <br /><br />Models: IaaS, PaaS, SaaS. <br />Services: AWS, Azure, GCP.",
    date: "2024-03-18",
    category: "Technology",
    author: "Tech Expert",
  },
  ...
  // For example, if page.tsx has a post with slug 'first-post', ensure it's here for metadata
  {
    ...
    description:
      "This is the description for my first blog post about web development.", // Desc from page.tsx
  ...
  },
  {
    ...
    description:
      "A guide to the most beautiful national parks and hiking trails.", // Matched description
