...
import { X, Mail, Lock, Github, Chrome, Sun, Moon, Phone } from 'lucide-react';
      ...
      <div className={`${isDarkMode ? 'bg-gray-800' : 'bg-white'} rounded-xl shadow-lg p-8 max-w-md w-full relative transform transition-all duration-300 ease-in-out`}>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full pl-10 px-4 py-2 border rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-all ${
                  isDarkMode 
          ...
          <div className="flex items-center justify-between">
            ...
            <a href="#" className={`text-sm text-indigo-600 hover:text-indigo-500 ${isDarkMode ? 'text-indigo-400 hover:text-indigo-300' : ''}`}>
              Forgot password?
            </a>
          </div>
