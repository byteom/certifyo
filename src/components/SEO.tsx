...
export default function SEO({
  title,
  description,
  keywords = 'certification, online exams, professional development, learning platform, skills verification, DSA, coding challenges, internships',
  ...
  const defaultJsonLd = {
    ...
    potentialAction: {
      ...
      target: {
        '@type': 'EntryPoint',
        urlTemplate: 'https://certifyo.tech/search?q={search_term_string}'
      },
